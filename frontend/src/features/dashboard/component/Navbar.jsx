...
function Navbar() {
  ...
  console.log(product)
	return (
		<header className="w-full border border-indigo-900/50 bg-[#0a0e21] px-4 py-4 shadow-[0_16px_40px_-28px_rgba(2,6,23,0.9)] sm:px-6">
			<div className="mx-auto flex w-full max-w-7xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
				...
				<div className="flex flex-wrap items-center gap-2 sm:justify-end">
                    ...
                    <div className="rounded-md border border-indigo-700/55 bg-indigo-950/35 px-3 py-1.5 text-xs font-medium uppercase tracking-[0.12em] text-indigo-300 sm:text-sm">
						{`$${product ? product.initialPrice.toLocaleString() : "0"}`}
					</div>
